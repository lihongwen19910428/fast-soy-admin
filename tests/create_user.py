...
async def add_user():
    ...
    for _ in range(6):
        ...
        user_create = await user_controller.create(UserCreate(user_name=random_str, user_email=f"{random_str}@user.com", password="123456", user_phone=random_phone, status_type=StatusType.enable))
