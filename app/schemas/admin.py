...
from app.models.system import IconType, LogType, MenuType, StatusType
...
class LogSearch(BaseLog):
    ...
    time_range: Annotated[tuple[datetime, datetime] | None, Field(alias="timeRange", description="时间范围")] = None
